  ...
  useEffect(() => {
    const fetchCommissions = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error('Komşyon geçmişi yüklenemedi');
        }
    ...
    return (
      <Card>
        <CardContent className="p-6">
          <div className="text-center text-gray-500">Komşyon geçmişi yükleniyor...</div>
        </CardContent>
      </Card>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Monoline MLM sistemi kapsamında kazandığınız tüm komşyonlar
          </CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
      ...
      <Card className="bg-blue-50 border-blue-200">
        <CardHeader>
          <CardTitle className="text-base">📋 Monoline MLM Komşyon Yapısı</CardTitle>
        </CardHeader>
        <CardContent>
